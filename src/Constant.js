export const TYPE_TAKE_CAMERA = 1
export const TYPE_TAKE_GALLERY = 2
export const TYPE_FRONT = 1
export const TYPE_BACK = 2
export const API_KEY = 'a08eb42a-4a57-449b-84f4-1f67219f2679'
export const RESULT_OK = 200
export const ADDRESS = 'address'
export const BIRTHDAY = 'birthday'
export const EXPIRY = 'expiry'
export const NUMBER_ID = 'id'
